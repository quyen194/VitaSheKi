...
enum LanguageContainer {
  ...
  VITASHELL_SETTINGS_DISABLE_SYSTEM_SLEEP,
  VITASHELL_SETTINGS_INSTALL_TYPE,
  ...
  VITASHELL_SETTINGS_INSTALL_REPLACE,
  VITASHELL_SETTINGS_INSTALL_UPDATE,
